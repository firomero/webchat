 ...
 */
class MyAppPersistenceUserHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['connection'])) {
            ...
            $return = (string) $value;
            $this->class->reflFields['connection']->setValue($document, $return);
            $hydratedData['connection'] = $return;
        }
